...
//        Backend.shared.config = BackendConfig(bundleId: "com.example.app", deviceToken: "", language: "bg", endpoints: BackendEndpoints(baseUrl: "http://localhost:8080", constantPrefix: "/en/api/", endpoints: [BackendEndpoint(types: [.login], version: .v1, path: "???")]), errors: [
