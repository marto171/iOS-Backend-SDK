...
final class LoginConfirmTest: XCTestCase {
    func testExample() async throws {
        print("START PROGRAM")
        print("------------------REQUESTRESETPASSWORDBYCURRENTPASSWORD--------------------")
        print("------------------REQUESTRESETPASSWORDBYCURRENTPASSWORD--------------------")
        print("------------------REQUESTRESETPASSWORDBYCURRENTPASSWORD--------------------")
        print("------------------REQUESTRESETPASSWORDBYCURRENTPASSWORD--------------------")
        print("------------------REQUESTRESETPASSWORDBYCURRENTPASSWORD--------------------")
        ...
        await Backend.shared.resetPasswordByCurrentPassword(password: "Az@dert123gg", newPassword: "Az@dert123gg", newPasswordConfirm: "Az@dert123gg", authToken: "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjY1MzYyZTA5MmVjZjgzNGQwOTRiZmM3YiIsImlhdCI6MTY5ODA4MTkwMCwiZXhwIjoxNzAzMjY1OTAwfQ.t9nKxVqDLhkMSj805xlb0vmOzfc-IMIIVQrFxg_bvX8") { status in
            switch status {
